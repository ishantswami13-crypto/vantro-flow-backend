...
const ALWAYS_REQUIRES_APPROVAL = new Set([
  ...
  'ASK_PARTIAL_PAYMENT',
  // STARLANE Phase 10 follow-up: revenue-intelligence recommendation, never
  // auto-approved — see revenueIntelligence.service.js runRevenueHealthWatchRule().
  'REVENUE_HEALTH_WATCH',
  // Day 1 sprint (2026-09-06/07): receivablesRiskAgent.js's own header already
  // documented this convention before wiring existed — this is that agent's
  // action_type now that it actually creates ai_actions rows.
  'RECEIVABLES_RISK_ALERT',
