...
// client_encoding IS read from PGCLIENT_ENCODING but getStartupConf does NOT write it to the
// startup packet, so it cannot inflate the packet.) PGOPTIONS is the critical one: no config
